...
import static kr.lul.common.test.AssertUpdatable.createdAfter;
import static kr.lul.common.test.AssertUpdatable.createdAfterAndUpdatedAfter;
import static kr.lul.common.test.AssertUpdatable.updatedAfter;
...
import kr.lul.common.data.UpdatableImpl;
...
public class AssertUpdatableTest extends AbstractJUnitTest {
  ...
  public void testCreatedAfterWithNull() {
    AssertAction.assertThese((callable) -> assertThatThrownBy(callable).isInstanceOf(AssertionException.class),
