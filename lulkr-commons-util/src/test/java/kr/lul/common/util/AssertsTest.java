...
import static kr.lul.common.util.Asserts.assignable;
import static kr.lul.common.util.Asserts.ge;
import static kr.lul.common.util.Asserts.gt;
import static kr.lul.common.util.Asserts.hasLength;
import static kr.lul.common.util.Asserts.in;
import static kr.lul.common.util.Asserts.isNull;
import static kr.lul.common.util.Asserts.le;
import static kr.lul.common.util.Asserts.length;
import static kr.lul.common.util.Asserts.longer;
import static kr.lul.common.util.Asserts.lt;
import static kr.lul.common.util.Asserts.matches;
import static kr.lul.common.util.Asserts.negative;
import static kr.lul.common.util.Asserts.notNegative;
import static kr.lul.common.util.Asserts.notNull;
import static kr.lul.common.util.Asserts.notPositive;
import static kr.lul.common.util.Asserts.positive;
import static kr.lul.common.util.Asserts.shorter;
import static kr.lul.common.util.Asserts.zero;
...
public class AssertsTest {
   ...
   * @since 2016. 8. 2.
   */
  static void assertThrowingCallables(Class<? extends Throwable> e, ThrowingCallable... callables) {
    notNull(e, "e");
